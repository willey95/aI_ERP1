                          ...
                          {items.map((item) => (
                            <tr key={item.id} className="hover:bg-gray-50">
                              <td className="px-6 py-4">
                                ...
                                {item.detailItem && <div className="text-xs text-gray-400">{item.detailItem}</div>}
                              </td>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4">
            ...
            <form onSubmit={handleSubmit} className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Detail Item</label>
                  <input
                    type="text"
                    value={formData.detailItem}
                    onChange={(e) => setFormData({ ...formData, detailItem: e.target.value })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="e.g., 현장사무소"
                  />
                </div>
